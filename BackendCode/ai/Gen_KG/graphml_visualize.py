...
from ai.Gen_KG.graph_rag import CURRENT_WORKING_DIRECTORY
...
def visualize_graphml(graphml_file, html_path):
    ...
    # 打开默认浏览器
    webbrowser.open('http://localhost:8001/graph_visualization.html')
...
if __name__ == "__main__":
    graphml_file = rf"{CURRENT_WORKING_DIRECTORY}/graph_chunk_entity_relation.graphml"
